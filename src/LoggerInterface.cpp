...
std::unique_ptr<logger::LoggerInterface> logger::LoggerInterface::logger{nullptr};
...
logger::LoggerInterface* logger::LoggerInterface::getLogger(){return LoggerInterface::logger.get();}

void logger::LoggerInterface::setLogger(LoggerInterface* logger){LoggerInterface::logger.reset(logger);}

std::ostream& logger::LoggerEvent::getStream(){return ostr;}

logger::LoggerEvent::LoggerEvent(LogLevel level, std::string const &file, std::string const &func, long long line):
